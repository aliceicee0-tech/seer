...
--
--  ⚠️ DROP + CREATE (pas CREATE OR REPLACE) car l'ordre des colonnes change.
-- ===========================================================================

drop view if exists public.v_markets;

create view public.v_markets as
select
