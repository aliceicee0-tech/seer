...
import { BarChart3, Layers, Wallet, User, HelpCircle, Search, Globe, CloudSun, Share2, TrendingUp, Trophy, Gift } from "lucide-react";
...
const NAV = [
  ...
  { to: "/referral", label: "Parrainage", icon: Gift, auth: true },
